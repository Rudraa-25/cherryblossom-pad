...
this is my custom 12 key macropad project for the hack club hackpad. it use a seeed xiao rp2040 and got 12 switch and a small oled display. i design the case in cad and the pcb in kicad. also when the physical parts arrive i am going to hand draw a little cherry tree on the case to make it look cool.
